...
namespace Radegast
{
    public class SlUriParser
    {
        ...
        private void ExecuteLinkRegionUri(Match match)
        {
            ...
            instance.ShowLocation(name, x, y, z);
        }
        ...
        private void ExecuteLinkAgent(Match match)
        {
            ...
            instance.ShowAgentProfile(instance.Names.Get(agentID), agentID);
        }

        private void ExecuteLinkShowAppearance()
        {
