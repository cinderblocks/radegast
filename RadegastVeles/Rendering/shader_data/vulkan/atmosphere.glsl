// Vulkan variant of ../atmosphere.glsl. See plan Section 7 -- same #define-aliasing
// approach as vulkan/shadow.glsl: every function body below is byte-identical to the GL
// original, only the uniform declarations changed (folded into the including shader's
// PerFrame UBO, since atmosphere params are per-frame data like lighting/shadow state).
//
// NOTE: do not put a #version directive in this file -- textually inlined below the
// including shader's own #version line, same as the GL original.

#define uBlueHorizon   frame.uBlueHorizon
#define uBlueDensity   frame.uBlueDensity
#define uHazeHorizon   frame.uHazeHorizon
#define uHazeDensity   frame.uHazeDensity
#define uSunlightColor frame.uSunlightColor
#define uAmbient       frame.uAmbient
#define uSunDirection  frame.uSunDirection
#define uSunGlowFocus  frame.uSunGlowFocus
#define uSunGlowSize   frame.uSunGlowSize
