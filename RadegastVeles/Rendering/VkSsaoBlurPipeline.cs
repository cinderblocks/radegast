...
internal sealed class VkSsaoBlurPipeline : IDisposable
{
    ...
    private VkSsaoBlurPipeline(VkContext vk, PipelineLayout layout, Pipeline pipeline, DescriptorSetLayout samplerLayout)
    {
        _vk = vk;
        Layout = layout;
        Pipeline = pipeline;
    ...
    public static unsafe VkSsaoBlurPipeline Create(VkContext vk, RenderPass renderPass)
    {
        ...
        try
        {
            ...
            return new VkSsaoBlurPipeline(vk, layout, pipeline, samplerLayout);
        }
        catch
        {
            var api = vk.Api;
        ...
        DescriptorSetLayout samplerLayout, out PipelineLayout layout, out Pipeline pipeline)
    {
        ...
        using var frag = VkShaderModule.LoadFromFile(vk, "Rendering/shader_data/vulkan/ssaoblur.frag.spv");
