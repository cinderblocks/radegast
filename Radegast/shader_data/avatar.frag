...
{
    // Guard against NaNs: NaN is not equal to itself
...
void main()
{
    ...
    // Strong ambient lighting for avatars (slightly stronger than prims)
    vec4 ambientContribution = ambientColor * tex * 2.5;
    vec4 diffuseContribution = diffuseColor * tex * lambert;
    
    // Use additive combination to preserve brightness
